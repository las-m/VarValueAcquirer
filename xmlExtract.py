...
#import time #just for developing
#from pprint import pprint #just for developing


#------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#Takes an xml saved in a variable of type string and returns the Control-Node.
def einlesen(fileString):
    root = minidom.parseString(fileString)
...
#------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#This is the function that does all the small stuff for you. 
#It takes the xml-filename as a parameter. 
...
def extractDataFromXML(fileString):
    controlNode = einlesen(fileString)
